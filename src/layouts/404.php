  ...
  <div class="bg-white">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-sm text-center">
        ...
        <a href="/rental-motor-listrik" class="inline-flex text-slate-700 border-2 border-slate-400 bg-primary-600 hover:bg-slate-500 hover:text-white focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center my-4">Back to Homepage</a>
      </div>
    </div>
  </div>
</section>
