      ...
      <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
        ...
        <form class="space-y-4 md:space-y-6" method="POST">
          ...
          <button type="submit" name="registration"
            class="w-full text-white bg-slate-600 hover:bg-slate-800 focus:ring-4 focus:outline-none focus:ring-slate-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
            Create an account
          </button>
          <div class="flex justify-center items-center">
            <a href="login.php" class="text-sm font-light text-slate-500 hover:underline">
